...
<div class="container">
  ...
  <form id="contact" action="./register_dev.php" method="post" enctype="multipart/form-data">
...
<input  style="position: absolute;
  ...
  top: 0;" type="file" name="fileToUpload" id="fileToUpload" accept="application/pdf"/>
    ...
    echo "Not a valid Phone Number";
      ...
      <input  type="text" name="phone"  Placeholder="Enter your phone number" data-toggle="tooltip" data-placement="right" title="Enter Your Phone Number" max="9999999999" >    
        </fieldset>
...
<!--      <textarea placeholder="Your Domains of Expertise. Eg. Java, Web Development, Machine Learning, Embedded Systems..." pattern="^([a-zA-Z0-9]+,?\s*)+$" type="text" name="domains" value="" tabindex="5" data-toggle="tooltip" data-placement="right" title="Enter your domains of expertise, seperated with commas" required></textarea>-->
            ...
            <select class="skills_select" name="skills[]" multiple required>
               ...
               <?php 
                try{
                $query = "SELECT skill_id,skill_name FROM skill_table";
    ...
    echo $e->getMessage();
      ...
      <fieldset>
      <input placeholder="Github Account URL - Recommended" type="text"  name="githublink" value="" >
      <span class="error"></span>
    </fieldset>
     ...
     <label class="customcheck">I agree to the <a href="#">terms and conditions</a> and <a target="_blank" href="../../docs/privacy-policy.txt">privacy policy</a>
      ...
      <fieldset style="color:white;">
          Already have an account? <a href="../panel/index.php">Login.</a>
      </fieldset>
    <fieldset>
